...
export const CONTENT_TYPES_REFERENCE = [
  ...
  },
  {
    ...
    CONTENT_TYPE_L2_NAME: "Mixed-Media Performance",
    Description:
      "Live presentations blending digital projections, sound, and physical performance.",
  },
  {
    CONTENT_TYPE_ID: "2347ac72-b5a0-4fde-bfcb-0fd1c7f0fbce",
    CONTENT_TYPE_NAME: "Mixed-Media Installation",
    ...
    CONTENT_TYPE_L2_NAME: "Mixed-Media Installation",
    Description:
      "Fixed or temporary spatial artworks combining screens, sensors, and interactivity.",
  },
  {
    CONTENT_TYPE_ID: "91a52572-f934-464d-9250-1d71760558f4",
    CONTENT_TYPE_NAME: "Mixed-Media Attraction",
    ...
    >
      ...
      <div style={{ padding: "22px 26px 10px" }}>
        ...
        >
          ...
          {/* ✅ Right side actions: Visualize button + ME-DMZ link */}
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <button
              type="button"
              onClick={() => navigate("/participants/organizations/content-types/visualize")}
              style={{
                border: `1px solid rgba(30,42,120,0.18)`,
                background: "#FFFFFF",
                color: BRAND.ink,
