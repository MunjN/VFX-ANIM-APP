...
function endpointForRows(viewMode) {
  if (viewMode === "tax") return "/api/views/tax-regions";
  if (viewMode === "geodata") return "/api/views/geodata";
  if (viewMode === "cloud") return "/api/views/cloud-regions";
  return "";
}

function endpointForFilters(viewMode) {
  if (viewMode === "tax") return "/api/views/tax-regions/filters";
  if (viewMode === "geodata") return "/api/views/geodata/filters";
  if (viewMode === "cloud") return "/api/views/cloud-regions/filters";
  return "";
}
